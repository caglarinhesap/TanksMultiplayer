...
public class HealingZone : NetworkBehaviour
{
    ...
    private List<TankPlayer> playersInHealingZone = new List<TankPlayer>();
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            playersInHealingZone.Add(player);
        }
    }
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        ...
        {
            playersInHealingZone.Remove(player);
        }
    }
    ...
    private void Update()
    {
        ...
        {
            foreach (TankPlayer player in playersInHealingZone)
            {
